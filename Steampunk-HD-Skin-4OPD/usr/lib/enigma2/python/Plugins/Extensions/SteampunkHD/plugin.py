...
config.plugins.Steampunk.woeid = ConfigNumber(default = 843722)
...
class Steampunk_Config(Screen, ConfigListScreen):

    skin = """
            <screen name="Steampunk_Config" position="center,center" size="1280,720" title="Steampunk Setup" >
                    <widget source="Title" render="Label" position="70,47" size="950,43" font="Regular;35" transparent="1" />
    ...
    def createConfigList(self):
        ...
        self.set_sb = getConfigListEntry(_("Selected_BackgroundColor:"), self.myAtileHD_sb)
        self.set_listbox = getConfigListEntry(_("ForegroundColor_Listbox:"), self.myAtileHD_listbox)
        self.set_background = getConfigListEntry(_("Background:"), self.myAtileHD_background)
        self.set_progr_infobar = getConfigListEntry(_("Infobar_Progress:"), self.myAtileHD_progr_infobar)
        self.set_infobar = getConfigListEntry(_("Infobar:"), self.myAtileHD_infobar)
        self.set_clock = getConfigListEntry(_("AnalogClock_Widget:"), self.myAtileHD_clock)
    ...
    def changedEntry(self):
        ...
        elif self["config"].getCurrent() == self.set_listbox:
            self.setPicture(self.myAtileHD_listbox.value)
    ...
    def keyYellow(self):
        if self.myAtileHD_active.value:
            self.session.openWithCallback(self.SteampunkScreenCB, SteampunkScreens)
        else:
    ...
    def keyGreen(self):
        if self["config"].isChanged():
            ...
            # listbox
            self.makeSettings(self.myAtileHD_listbox, self.listbox_file)
            # background
    ...
    def about(self):
        self.session.open(Steampunk_About)
...
class SteampunkScreens(Screen):
    ...
    skin = """
            <screen name="SteampunkScreens" position="center,center" size="1280,720" title="Steampunk Setup">
                    <widget source="Title" render="Label" position="70,47" size="950,43" font="Regular;35" transparent="1" />
